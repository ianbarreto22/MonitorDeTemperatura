...
public class NatalServer extends UnicastRemoteObject implements TempServerInterface {
	...
	private static final String LAT = "-5.79448";
	private static final String LON = "-35.211";
	private static final String NAME = "Natal";
	
	protected NatalServer() throws RemoteException {
		super();	
